...
export function PBTheCheckbox<T>({field_key,field_name,validation_error,pb_error,prev_error_message,onChange}:PBTheCheckboxProps<T>){
  ...
  return (
    ...
    {error_message && (
      ...
      <Checkbox id={field_key as string} onChange={onChange} className={default_input_tw}/>
      <label
        htmlFor="terms"
